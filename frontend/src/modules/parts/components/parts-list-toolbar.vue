<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/parts/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary">
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/parts/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'parts' } }"
...
export default {
  name: 'app-parts-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'parts/list/hasRows',
      loading: 'parts/list/loading',
      exportLoading: 'parts/list/exportLoading',
      selectedRows: 'parts/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new PartsPermissions(this.currentUser).create;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'parts/list/doExport',
      doRemoveAllSelected:
        'parts/list/doRemoveAllSelected',
      doDisableAllSelected:
        'parts/list/doDisableAllSelected',
      doEnableAllSelected:
        'parts/list/doEnableAllSelected',
      doDestroyAll: 'parts/destroy/doDestroyAll',
    }),
