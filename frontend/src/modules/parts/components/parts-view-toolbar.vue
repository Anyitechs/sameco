<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: `/parts/${record.id}/edit` }" v-if="record && hasPermissionToEdit">
...
export default {
  ...
  computed: {
    ...
    hasPermissionToImport() {
      return new PartsPermissions(this.currentUser).import;
    },
