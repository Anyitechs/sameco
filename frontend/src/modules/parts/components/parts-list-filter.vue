<template>
  ...
  >
    <el-row>
      ...
      <!-- <el-col :lg="12" :md="16" :sm="24">
        <el-form-item
          :label="fields.stockRange.label"
          :prop="fields.stockRange.name"
        >
          <app-number-range-input v-model="model[fields.stockRange.name]"/>
        </el-form-item>
      </el-col> -->
    </el-row>
...
export default {
  ...
  methods: {
    ...mapActions({
      doReset: 'parts/list/doReset',
      doFetch: 'parts/list/doFetch',
    }),
