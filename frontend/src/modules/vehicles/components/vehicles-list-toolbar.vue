<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/vehicles/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary">
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/vehicles/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'vehicles' } }"
...
export default {
  name: 'app-vehicles-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'vehicles/list/hasRows',
      loading: 'vehicles/list/loading',
      exportLoading: 'vehicles/list/exportLoading',
      selectedRows: 'vehicles/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new VehiclesPermissions(this.currentUser).create;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'vehicles/list/doExport',
      doRemoveAllSelected:
        'vehicles/list/doRemoveAllSelected',
      doDisableAllSelected:
        'vehicles/list/doDisableAllSelected',
      doEnableAllSelected:
        'vehicles/list/doEnableAllSelected',
      doDestroyAll: 'vehicles/destroy/doDestroyAll',
    }),
