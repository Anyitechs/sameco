<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: `/vehicles/${record.id}/edit` }" v-if="record && hasPermissionToEdit">
...
export default {
  name: 'app-vehicles-view-toolbar',
  ...
  computed: {
    ...
    hasPermissionToImport() {
      return new VehiclesPermissions(this.currentUser).import;
    },
