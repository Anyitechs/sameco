...
import vehiclesListExporterFields from '@/modules/vehicles/vehicles-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!vehiclesListExporterFields || !vehiclesListExporterFields.length) {
          throw new Error('vehiclesListExporterFields is required');
        }
