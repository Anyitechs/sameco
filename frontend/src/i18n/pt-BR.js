const ptBR = {
  ...
  entities: {
    parts: {
      ...
      label: 'Motor Parts',
      menu: 'Motor Parts',
      exporterFileName: 'Motor Parts_exportados',
      list: {
        menu: 'Motor Parts',
        title: 'Motor Parts',
      },
      create: {
        success: 'Motor Parts salvo com sucesso',
      },
      update: {
        success: 'Motor Parts salvo com sucesso',
      },
      destroy: {
        success: 'Motor Parts deletado com sucesso',
      },
      destroyAll: {
        success: 'Motor Parts(s) deletado com sucesso',
      },
      edit: {
        title: 'Editar Motor Parts',
      },
      fields: {
        id: 'Id',
        'name': 'Name',
      ...
      new: {
        title: 'Novo Motor Parts',
      },
      view: {
        title: 'Visualizar Motor Parts',
      },
      importer: {
        title: 'Importar Motor Parts',
        fileName: 'parts_template_importacao',
        hint:
    ...
    vehicles: {
      ...
      label: 'Vehicles',
      menu: 'Vehicles',
      exporterFileName: 'Vehicles_exportados',
      list: {
        menu: 'Vehicles',
        title: 'Vehicles',
      },
      create: {
        success: 'Vehicles salvo com sucesso',
      },
      update: {
        success: 'Vehicles salvo com sucesso',
      },
      destroy: {
        success: 'Vehicles deletado com sucesso',
      },
      destroyAll: {
        success: 'Vehicles(s) deletado com sucesso',
      },
      edit: {
        title: 'Editar Vehicles',
      },
      fields: {
        id: 'Id',
      ...
      view: {
        title: 'Visualizar Vehicles',
      },
      importer: {
        title: 'Importar Vehicles',
        fileName: 'vehicles_template_importacao',
        hint:
          'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
      },
    },
    ...
    overhead: {
      ...
      label: 'Overheads',
      menu: 'Overheads',
      exporterFileName: 'Overhead_exportados',
      list: {
        menu: 'Overheads',
        title: 'Overheads',
      },
      create: {
        success: 'Overhead salvo com sucesso',
      },
      update: {
        success: 'Overhead salvo com sucesso',
      },
      destroy: {
        success: 'Overhead deletado com sucesso',
      },
      destroyAll: {
        success: 'Overhead(s) deletado com sucesso',
      },
      edit: {
      ...
      view: {
        title: 'Visualizar Overhead',
      },
      importer: {
        title: 'Importar Overheads',
        fileName: 'overhead_template_importacao',
        hint:
          'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
      },
    },
  ...
  roles: {
    ...
    partsEditor: {
      label: 'Editor de Motor Parts',
      description: 'Acesso de edição aos Motor Parts',
    },
    partsViewer: {
      label: 'Visualizador de Motor Parts',
      description: 'Acesso de visualização aos Motor Parts',
    },
    vehiclesEditor: {
      label: 'Editor de Vehicles',
      description: 'Acesso de edição aos Vehicles',
    },
    vehiclesViewer: {
      label: 'Visualizador de Vehicles',
      description: 'Acesso de visualização aos Vehicles',
    },
    overheadEditor: {
      label: 'Editor de Overheads',
      description: 'Acesso de edição aos Overheads',
    },
    overheadViewer: {
      label: 'Visualizador de Overheads',
      description: 'Acesso de visualização aos Overheads',
    },
  },
