...
/**
 * Handles Parts operations
 */
module.exports = class PartsService {
  ...
  /**
   * Destroy all Partss with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Partss based on the query.
   *
   * @param {*} args
   */
