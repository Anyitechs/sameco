...
module.exports = class VehiclesService {
  ...
  /**
   * Destroy all Vehicless with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Vehicless for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds Vehicless based on the query.
   *
   * @param {*} args
   */
